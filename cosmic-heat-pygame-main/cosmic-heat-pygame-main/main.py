...
shooting_animation_images = [
    ...
    pygame.image.load('images/Protagonista/player_shooting2.png').convert_alpha(),
    pygame.image.load('images/Protagonista/player_shooting3.png').convert_alpha(),
    pygame.image.load('images/Protagonista/player_shooting4.png').convert_alpha(),
]
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_SPACE and not paused:
                if bullet_counter > 0 and pygame.time.get_ticks() - last_shot_time > SHOOT_DELAY:
                    ...
                    for image in shooting_animation_images:
                        player.image = image
                        screen.blit(current_image, (0, bg_y_shift))
                        screen.blit(player.image, player.rect)
                        pygame.display.flip()
                        pygame.time.delay(1)  # Ajusta este valor según la velocidad de la animación
